...
```
git remote set-url origin https://github.com/mikebin/lsbeat
...
```
mkdir -p ${GOPATH}/github.com/mikebin
cd ${GOPATH}/github.com/mikebin
git clone https://github.com/mikebin/lsbeat
```
